...
const Content = () =>{
    return (
        <main>
            <img class="google-img" alt="Google" src="https://www.google.com/images/branding/googlelogo/2x/googlelogo_color_272x92dp.png" />
            <form id="search-form" class="search-form">
                <div class="search-input">
                    <div id = "search-line" class="search-line">
                        <svg class="svg-search" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                        ...
                        <svg class="svg-voice" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
